...
class rltsdr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RTL SDR Test 1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL SDR Test 1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rltsdr")
...
def main(top_block_cls=rltsdr, options=None):
